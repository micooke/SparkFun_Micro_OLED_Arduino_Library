...
Version History
---------------
* [v 1.2.0](https://github.com/micooke/sparkfun_OLED) - @micooke Rewrite & Tidy-up. Arbitrary screen dimensions, SoftwareI2C (https://github.com/micooke/SoftwareI2C) supported
